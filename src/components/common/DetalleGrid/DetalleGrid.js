...
export default function DetalleGrid({
  ...
  return (
    <Grid item xs={12}>
      <CabezeraInforme textoFiltros={textoFiltros} />
      ...
      <MaterialTable
        ...
        options={{ ...options(titulo, textoCabeza), ...otrasOpciones }}
        localization={{ ...localization, ...otrasLocalization }}
        onRowClick={
          onVisualizar
            ? (event, rowData, togglePanel) => onVisualizar(rowData)
            : undefined
        }
