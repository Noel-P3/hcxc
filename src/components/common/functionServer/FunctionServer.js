...
export const Grabar = (rutaAPI, info, isCrearModificar) =>
  serverCall(
    baseUrl +
      rutaAPI +
 ...
 */
export const GrabarCustom = (
  rutaAPI = "",
  documento = {},
  noMostrarMensaje = false
) =>
  serverCall(
    baseUrl + rutaAPI,
    "POST",
 ...
 */
export const GrabarVariosDocumentosNuevos = (rutaAPI = "", info = []) =>
  serverCall(
    baseUrl + rutaAPI,
    "POST",
    null,
...
export const Get = (rutaAPI, filtro, arregloHeaders) =>
  serverCall(
...
export const Ejecutar = (rutaAPI, arregloHeaders, body, message) =>
  serverCall(
    baseUrl + rutaAPI,
    "POST",
    arregloHeaders,
...
export const Eliminar = (rutaAPI, id, noMostrarMensaje) =>
  serverCall(
    baseUrl + rutaAPI + `/${id}`,
    "DELETE",
    null,
